...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/ueditor/lang/zh-cn/zh-cn.js"></script>
 ...
 <body>
   ...
   <div class="easyui-panel">
     ...
     <form class="easyui-form" action="">
     
       <table>
        <tr>
         <td>天气情况:</td>
         <td><input type="text" id="weather"></td>
        <td>作者:</td>
         <td><input id="author" value="${user.username }" disabled="disabled"></td>
     ...
     <span>文章标题:</span>  <input type="text" id="title" size="100">
   ...
   //保存内容 
    function saveDiary(){
	   //获取百度编辑器的内容 
    	...
    	$.post("${pageContext.request.contextPath}/diary/saveDiary.htm",
    			{
    		    content:art,
    		    title:$("#title").val(),
    		    weather:$("#weather").val(),
